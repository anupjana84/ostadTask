...
class _CompletedScreenState extends State<CompletedScreen> {
  ...
  _initCall() {
    Get.find<NewTaskController>().getdata(Api.completedTask);
  }
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return TaskItem(
                                  ...
                                  onUpdate: _initCall
                                  // title: newTaskController
                                  //         .newTaskList[index].title
                                  //         ?.toUpperCase() ??
                                  //     '',
                                  // description: newTaskController
                                  ...
                                  // onClick: () {
                                  //   _deleteTask(
                                  //       newTaskController.newTaskList[index].sId);
                                  // },
                                  // deleLoding: _isLoadingDeleteMap[
                                  //         newTaskController
                                  //             .newTaskList[index].sId] ??
                                  //     false,
                                  // id: newTaskController.newTaskList[index].sId
                                  //     .toString(),
    ...
    if (result) {
      if (mounted) {
        ...
        Timer(const Duration(seconds: 1), () {
          newTaskController.getdata(Api.completedTask);
        });
      }
    } else {
      if (mounted) {
